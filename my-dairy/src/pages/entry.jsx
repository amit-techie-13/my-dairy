...
<h1 className="text-4xl font-bold bg-gradient-to-tr from-amber-700 via-amber-500 to-amber-200 bg-clip-text text-transparent mb-6">Samarooh – Everything You Need to Celebrate Is just a click away.</h1>
